...
//  scroll(0,0);
  twitchApi.channel(searchTxt).success(function (data){
    ...
    if(data.hasOwnProperty('error')){
      ...
      $scope.searchedChannelData = {url:"https://www.youtube.com/watch?v=ljmEkWkT5Qc", logo:"./img/notfound.jpg",video_banner: "./img/notfoundBackground.jpg" ,display_name : title, status:"Staring at the unknown",followers: "You", updated_at: "2018-07-15T11:00:43Z",views:"0"};
    }
  }).error(function(data){
